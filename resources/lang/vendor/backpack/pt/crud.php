...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Comportamento predefinido depois de gravar.',
    ...
    'details_row_loading_error' =>
        'Houve um erro ao carregar os detalhes. Por favor tente novamente.',
    ...
    'delete_confirmation_not_message' =>
        'Ocorreu um erro. O item pode não ter sido apagado.',
    'delete_confirmation_not_deleted_title' => 'Não apagado',
    'delete_confirmation_not_deleted_message' =>
        'Está tudo bem! O item não foi apagado.',

    // Bulk actions
    'bulk_no_entries_selected_title' => 'Nenhum item seleccionado',
    'bulk_no_entries_selected_message' =>
        'Por favor seleccione um ou mais itens para realizar uma acção em massa aos mesmos.',

    // Bulk confirmation
    'bulk_delete_are_you_sure' =>
        'Tem a certeza que quer apagar estes :number itens?',
    ...
    'ajax_error_text' =>
        'Erro ao carregar a página. Por favor actualize a página.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Acesso não autorizado - não tem as permissões necessárias para ver esta página.',
    ...
    'internal_link_placeholder' =>
        'Slug interno. Ex: \'admin/page\' (sem aspas) para \':url\'',
