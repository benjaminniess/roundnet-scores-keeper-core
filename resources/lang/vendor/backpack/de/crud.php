...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Standardverhalten nach dem Speichern wurde geändert.',
    ...
    'admin' => 'Admin',
    'details_row' =>
        'Diese Zeile zeigt die Details und kann nach Belieben geändert werden.',
    'details_row_loading_error' =>
        'Beim Laden der Details ist ein Fehler aufgetreten. Bitte versuche es noch einmal.',
    ...
    'delete_confirmation_not_message' =>
        'Ein Fehler ist aufgetreten. Der Eintrag wurde möglicherweise nicht gelöscht.',
    'delete_confirmation_not_deleted_title' => 'Nicht gelöscht',
    'delete_confirmation_not_deleted_message' =>
        'Nichts passiert. Der Eintrag wurde nicht gelöscht.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Unbefugter Zugriff - Sie haben nicht die notwendigen Rechte um diese Seite anzuzeigen.',
    ...
    'reorder' => 'Sortiere',
    'reorder_text' =>
        'Zum Ändern der Reihenfolge Einträge verschieben. (Drag&Drop)',
    ...
    'internal_link_placeholder' =>
        'URL-sicherer Name ("Slug"). Bsp: \'admin/page\' (ohne Anführungszeichen) für \':url\'',
