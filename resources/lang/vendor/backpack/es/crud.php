...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'La acción por defecto del botón guardar ha sido modificada.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Acceso denegado - usted no tiene los permisos necesarios para ver esta página.',
    ...
    'internal_link_placeholder' =>
        'Slug interno. Ejplo: \'admin/page\' (sin comillas) para \':url\'',
