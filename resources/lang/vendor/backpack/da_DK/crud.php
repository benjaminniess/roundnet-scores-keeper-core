...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'standard handling efter gem er blevet ændret.',
    ...
    'details_row_loading_error' =>
        'Der opstod en fejl under indlæsningen af detajlerne. Prøv igen.',
    ...
    'delete_confirmation_not_message' =>
        'Der opstod en fejl. Dit emne er måske ikke fjernet.',
    'delete_confirmation_not_deleted_title' => 'ikke fjernet',
    'delete_confirmation_not_deleted_message' =>
        'Der skete intet. Dit emne er i god behold',
    ...
    'aria' => [
        'sortAscending' =>
            ': aktiver for at sortere kolonen efter stigende rækkefølge',
        'sortDescending' =>
            ': aktiver for at sortere kolonen efter faldende rækkefølge'
    ],

    // global crud - errors
    'unauthorized_access' =>
        'Ingen adgang - Du har ikke de nødvendige rettigheder for at se denne side.',
    ...
    'internal_link_placeholder' =>
        'Interne slug. Ex: \'admin/side\' (no quotes) for \':url\'',
