...
return [
    ...
    'save_action_changed_notification' =>
        'Kaydedildikten sonra varsayılan davranış değiştirildi.',
    ...
    'details_row_loading_error' =>
        'Ayrıntılar yüklenirken bir hata oluştu. Lütfen tekrar deneyiniz.',
    'confirm_delete' => 'Evet',
    ...
    'delete_confirmation_not_message' =>
        'Bir hata oluştu. Öğeniz silinmemiş olabilir.',
    'delete_confirmation_not_deleted_title' => 'Silinmedi',
    'delete_confirmation_not_deleted_message' =>
        'Hiçbir şey olmadı. Öğeniz güvende.',

    // Bulk actions
    'bulk_no_entries_selected_title' => 'Kayıt seçilmedi',
    'bulk_no_entries_selected_message' =>
        'Lütfen toplu işlem gerçekleştirmek için bir veya daha fazla öğe seçin.',

    // Bulk confirmation
    'bulk_delete_are_you_sure' =>
        'Bunları silmek istediğinizden emin misiniz? :number öğe',
    ...
    'ajax_error_text' =>
        'Sayfa yüklenirken hata oluştu. Lütfen sayfayı yenileyin.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Yetkisiz erişim - bu sayfayı görmek için gerekli izinlere sahip değilsiniz.',
    ...
    'internal_link_placeholder' =>
        'İç sayfa slug. Örn: \'admin/sayfa\' (tırnak isareti yok) => \':url\'',
