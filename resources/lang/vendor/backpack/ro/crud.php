...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'A fost salvată preferința redirecționării după salvare.',
    ...
    'details_row_loading_error' =>
        'A apărut o eroare la încărcarea detaliilor. Te rog să reîncerci.',
    ...
    'delete_confirmation_not_message' =>
        'A avut loc o eroare. E posibil ca intrarea să nu fi fost ștearsă.',
    'delete_confirmation_not_deleted_title' => 'Intrarea nu a fost ștearsă',
    'delete_confirmation_not_deleted_message' =>
        'Nu am șters intrarea din baza de date.',
    'ajax_error_title' => 'Eroare',
    'ajax_error_text' =>
        'Eroare la încărcarea paginii. Te rog să reîncarci pagina.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Acces neautorizat - Nu ai permisiunea necesară pentru a accesa pagina.',
    ...
    'internal_link_placeholder' =>
        'Rută internă. De ex: \'admin/page\' (fără ghilimele) pentru \':url\'',
