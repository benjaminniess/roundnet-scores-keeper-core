...
return [
    ...
    */
    ...
    'details_row' =>
        'Questa è la riga dei dettagli. Modificala a tuo piacimento.',
    'details_row_loading_error' =>
        "C'è stato un errore caricando i dettagli. Riprova.",
    ...
    'delete_confirmation_not_message' =>
        "C'è stato un errore. L'elemento potrebbe non essere stato eliminato.",
    'delete_confirmation_not_deleted_title' => 'Non eliminato',
    'delete_confirmation_not_deleted_message' =>
        "Non è successo niente. L'elemento è al sicuro.",

    // Bulk actions
    'bulk_no_entries_selected_title' => 'Nessun record selezionato',
    'bulk_no_entries_selected_message' =>
        'Seleziona uno o più record su cui effetturare l\'operaione.',

    // Bulk confirmation
    'bulk_delete_are_you_sure' =>
        'Sei sicuro di voler eliminare :number record?',
    ...
    'bulk_delete_error_message' =>
        'Non è stato possibile eliminare uno o più record',

    'ajax_error_title' => 'Errore',
    'ajax_error_text' =>
        'Errore durante il caricamento della pagina. Per favore ricarica la pagina.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Accesso non autorizzato - non hai i permessi necessari per vedere questa pagina.',
    ...
    'internal_link_placeholder' =>
        'Slug interno. Es: \'admin/page\' (no quotes) for \':url\'',
