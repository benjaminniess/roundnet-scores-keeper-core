...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Výchozí chování po uložení bylo změněno.',
    ...
    'details_row_loading_error' =>
        'Při načítání podrobností došlo k chybě. Zkuste to prosím znovu.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Neautorizovaný pristup - pro zobrazení této stránky nemáte potrebna opravneni.',
    ...
    'internal_link_placeholder' =>
        'Interní slug. např.: \'admin/page\' (bez uvozovek) pro \':url\'',
