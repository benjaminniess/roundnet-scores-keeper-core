...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Действие после сохранения было изменено',
    ...
    'details_row_loading_error' =>
        'Произошла ошибка при загрузке сведений. Повторите операцию.',
    ...
    'internal_link_placeholder' =>
        'Внутренний путь. Например: \'admin/page\' (без кавычек) для \':url\'',
