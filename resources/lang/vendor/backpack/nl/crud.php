...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Standaard gedrag na opslaan is aangepast.',
    ...
    'details_row_loading_error' =>
        'Er is een fout opgetreden bij het laden van de details. Probeer het opnieuw.',
    ...
    'delete_confirmation_not_message' =>
        'Er is een fout opgetreden. Het item is misschien niet verwijderd.',
    'delete_confirmation_not_deleted_title' => 'Niet verwijderd',
    'delete_confirmation_not_deleted_message' =>
        'Er is niks gebeurd. Je item is veilig.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Geen toegang - je hebt niet de benodigde rechten om deze pagina te bekijken.',
    ...
    'internal_link_placeholder' =>
        'Interne slug. B.v.: \'admin/page\' (geen quotes) voor \':url\'',
