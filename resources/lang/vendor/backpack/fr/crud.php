...
return [
    ...
    */
    ...
    'details_row_loading_error' =>
        'Une erreur est survenue en chargeant les détails. Veuillez réessayer.',
    ...
    'delete_confirmation_not_message' =>
        'Une erreur est survenue. Votre élément n’a peut-être pas été effacé.',
    'delete_confirmation_not_deleted_title' => 'Non supprimé',
    'delete_confirmation_not_deleted_message' =>
        'Aucune modification. Votre élément a été conservé.',

    // Bulk actions
    'bulk_no_entries_selected_title' => 'Aucun élément sélectionné',
    'bulk_no_entries_selected_message' =>
        'Veuillez sélectionner un ou plusieurs éléments pour faire une action groupée',

    // Bulk confirmation
    'bulk_delete_are_you_sure' =>
        'Souhaitez-vous vraiment supprimer ces :number éléments?',
    ...
    'bulk_delete_error_message' =>
        'Un ou plusieurs éléments n’ont pu être supprimés',

    // Ajax errors
    'ajax_error_title' => 'Erreur',
    'ajax_error_text' =>
        'Erreur lors du chargement. Merci de réactualiser la page.',
    ...
    'aria' => [
        'sortAscending' =>
            ': activez pour trier la colonne par ordre croissant',
        'sortDescending' =>
            ': activez pour trier la colonne par ordre décroissant'
    ],
    'export' => [
        'copy' => 'Copier',
        'excel' => 'Excel',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Accès non autorisé - vous n’avez pas les droits nécessaires à la consultation de cette page.',
    ...
    'internal_link_placeholder' =>
        'Identifiant de lien interne. Ex: \'admin/page\' (sans guillemets) pour \':url\'',
