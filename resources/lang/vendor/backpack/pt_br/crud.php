...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Comportamento padrão após salvar foi alterado.',
    ...
    'admin' => 'Admin',
    'details_row' =>
        'Esta são os detalhes do registro. Faça as modificações necessárias.',
    'details_row_loading_error' =>
        'Ocorreu um erro durante o carregamento dos detalhes. Por favor, tente novamente.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Acesso negado - você não possui a permissão necessária para acessar esta página.',
    ...
    'internal_link_placeholder' =>
        'Endereço interno. Ex: \'admin/pagina\' (sem aspas) para \':url\'',
