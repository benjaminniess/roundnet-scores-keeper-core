    ...
    public function up()
    {
        ...
        if ( Schema::hasColumn( 'games', 'player1' ) ) {
            Schema::table('games', function (Blueprint $table) {
                $table->dropForeign('games_player1_foreign');
            });
            Schema::table('games', function (Blueprint $table) {
            ...
            Schema::table('games', function (Blueprint $table) {
                $table->dropForeign('games_player2_foreign');
            });
            Schema::table('games', function (Blueprint $table) {
            ...
            Schema::table('games', function (Blueprint $table) {
                $table->dropForeign('games_player3_foreign');
            });
            Schema::table('games', function (Blueprint $table) {
            ...
            Schema::table('games', function (Blueprint $table) {
                $table->dropForeign('games_player4_foreign');
            });
            Schema::table('games', function (Blueprint $table) {
