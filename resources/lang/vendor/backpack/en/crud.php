...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Default behaviour after saving has been changed.',
    ...
    'details_row_loading_error' =>
        'There was an error loading the details. Please retry.',
    ...
    'bulk_no_entries_selected_message' =>
        'Please select one or more items to perform a bulk action on them.',

    // Bulk confirmation
    'bulk_delete_are_you_sure' =>
        'Are you sure you want to delete these :number entries?',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Unauthorized access - you do not have the necessary permissions to see this page.',
