...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Uzvedība pēc noklusējuma pēc izmaiņu saglabāšanas.',
    ...
    'details_row_loading_error' =>
        'Notika kļuda lādējot detaļas. Lūdzu atkārtojiet.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Neautorizēta pieeja - jums nav nepieciešamo tiesību lai apskatītu šo lapu.',
    ...
    'internal_link_placeholder' =>
        'Iekšējās saites vārds. Piemēram: \'admin/page\' (no quotes) for \':url\'',
