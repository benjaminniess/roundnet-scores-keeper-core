...
return [
    ...
    'save_action_changed_notification' =>
        'Η προκαθορισμένη συμπεριφορά μετά την αποθήκευση έχει αλλάξει.',
    ...
    'admin' => 'Διαχειριστής',
    'details_row' =>
        'Αυτή είναι η γραμμή λεπτομερειών. Τροποποιήστε την όπως επιθυμείτε.',
    'details_row_loading_error' =>
        'Υπήρξε ένα σφάλμα κατά τη φόρτωση λεπτομερειών. Παρακαλώ δοκιμάστε ξανά.',

    // Confirmation messages and bubbles
    'delete_confirm' =>
        'Είστε σίγουρος/η πως θέλετε να διαγράψετε αυτό το αντικείμενο?',
    ...
    'delete_confirmation_not_deleted_message' =>
        'Δεν έγινε τίποτα. Το αντικείμενό σας είναι ασφαλές.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Μη εξουσιοδοτημένη πρόσβαση - δεν έχετε την απαιτούμενη εξουσιοδότηση για να δείτε τη σελίδα αυτή.',
    ...
    'internal_link_placeholder' =>
        'Εσωτερικό slug. πχ: \'admin/page\' (χωρίς εισαγωγικά) για \':url\'',
