...
return [
    ...
    */
    ...
    'save_action_changed_notification' =>
        'Действието след запис по подразбиране слез запис беше променено.',
    ...
    'details_row_loading_error' =>
        'Възникна грешка при зареджането на детайлите. Моля опитайте отново.',
    ...
    // global crud - errors
    'unauthorized_access' =>
        'Неразрешен достъп - нямате необходимите разрешения, за да видите тази страница.',
    ...
    'internal_link_placeholder' =>
        'Вътрешен слъг. Пр: \'admin/page\' (без кавички) за \':url\'',
